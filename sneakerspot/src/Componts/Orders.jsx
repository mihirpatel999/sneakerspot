...
export const Orders = () => {
    ...
    // Fetch Orders from API and Update Redux Store
    useEffect(() => {
        const fetchOrders = () => {
    ...
    return (
        <>
            <div className='container shadow' id='data'>
                <h1>Orders</h1> <hr />
                        ...
                        <tbody>
                            ...
                            {orders.map((order, index) =>
                                <tr key={index}>
                                    ...
                                    <td>
                                        <button type="button" className="btn btn-primary" onClick={() => navigate(`/admin/orders/${order.id}`)}> View </button>
                                    </td>
                                </tr>
                            )}
                        </tbody>
